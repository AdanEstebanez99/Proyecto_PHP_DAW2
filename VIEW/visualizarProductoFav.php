...
<html>
  <head>
    ...
    <?php
    if(!$_GET){
        header('Location: ./visualizarProductoFav.php?pagina=1');
    }
    ?>
...
<body data-usuario="<?php echo $_SESSION['usuario']?>">
  ...
  <script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
          method  : "POST",
          url     : "../CONTROLLER/controladorPaginacionProdFav.php",
          dataType: "json",
          data: {
          ...
          success : function(data) {
                ...
                for(i=1; i<=data; i++) {
                    if (i == $pagina) {
                       $(".pagination").append("<a class=\"selPag\" href=\"./visualizarProductoFav.php?pagina="+i+"\">"+i+"</a>"); 
                    } else {
                        $(".pagination").append("<a href=\"./visualizarProductoFav.php.php?pagina="+i+"\">"+i+"</a>");
                    }
                }
            }   
        });
      ...
      function getMotos() {
        ...
        $pagina = $.urlParam('pagina');
        $url = "../CONTROLLER/controladorGaleriaFav.php";
